...
$(document).on("click", "#checkdetale1", function() {	
	...
	$("#hobby1").val(obj[index].hobby);
	$("#begin1").val(obj[index].begin_time);
	$("#end1").val(obj[index].end_time);
	$("#description1").val(obj[index].hobby_description);
	$("#edit").modal('show');
