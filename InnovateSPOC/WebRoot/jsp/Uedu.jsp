...
#preview2{
  ...
  <body>
				...
				<div class="modal-dialog">
					<div class="modal-content" style="border:#3071a9 8px solid">
						...
						<div class="modal-body table-responsive">
							<div class="row">
								<div class="col-md-12">
									<form action="updateUEducation.do" method="post" class="form-horizontal"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body table-responsive">
					<div class="row">
						<div class="col-md-12">
							<form action="addUEducation.do" method="post" class="form-horizontal" enctype="multipart/form-data"
	...
	<script src="../js/myNeed/Uedu.js"></script>	
