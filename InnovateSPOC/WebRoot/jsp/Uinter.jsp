...
#preview2{
  ...
  <body>
				...
				<div class="page-header">
					<div class="pull-left">
						<ol class="breadcrumb visible-sm visible-md visible-lg">
							<li><a>位置</a></li>
							<li><a href="RepairManage.jsp">实习经历管理</a></li>
						</ol>
					</div>
				...
				<div class="modal-dialog">
					<div class="modal-content" style="border:#3071a9 8px solid">
						<div class="modal-header" style="background:#3071a9; color:#FFF">
							...
							<h4 class="modal-title text-center" id="myModalLabel">实习经历详情及修改</h4>
						</div>
						<div class="modal-body table-responsive">
							<div class="row">
								<div class="col-md-12">
									<form action="updateUInternship.do" method="post" class="form-horizontal"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title text-center" id="myModalLabel">实习经历信息</h4>
				</div>
				<div class="modal-body table-responsive">
					<div class="row">
						<div class="col-md-12">
							<form action="addUinternship.do" method="post" class="form-horizontal" enctype="multipart/form-data"
										role="form" id="applyaddform">
								<table class="table" style="border:none !important;">
									<tr>
										<td>学生id ：<span class="setTag">*</span></td>
										<td><input type="text" class="form-control" id="sid1"
											name="sid1" readonly /></td>
									</tr>
									<!-- <tr>
	...
	<script src="../js/myNeed/Uinter.js"></script>	
